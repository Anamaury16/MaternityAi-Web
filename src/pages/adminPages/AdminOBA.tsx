...
const CONTENIDO_INIT: ContenidoOBA[] = [
  {
    ...
    descripcion: 'Rutina suave recomendada para las primeras 12 semanas de gestación. Ayuda a mantener la movilidad.',
    tipo: 'VIDEO',
    imagen: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=400&h=200&fit=crop',
    categoria: 'Trimestre 1',
  },
  {
    id: 2,
    titulo: 'Alimentos a evitar',
    descripcion: 'Guía completa sobre qué alimentos crudos o procesados debes evitar durante el primer trimestre.',
    tipo: 'ARTÍCULO',
    imagen: 'https://images.unsplash.com/photo-1610832958506-aa56368176cf?w=400&h=200&fit=crop',
    categoria: 'Trimestre 1',
  },
  {
    id: 3,
    titulo: 'Primeros síntomas',
    descripcion: 'Cómo identificar y manejar las náuseas matutinas y el cansancio extremo.',
    tipo: 'ARTÍCULO',
    imagen: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=400&h=200&fit=crop',
    categoria: 'Trimestre 1',
  },
  {
    id: 4,
    titulo: 'Yoga prenatal T2',
    descripcion: 'Sesión de yoga adaptada al segundo trimestre para aliviar el dolor de espalda.',
    tipo: 'VIDEO',
    imagen: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=400&h=200&fit=crop',
    categoria: 'Trimestre 2',
  },
  {
    id: 5,
    titulo: 'Nutrición balanceada',
    descripcion: 'Guía de alimentación saludable para el segundo trimestre con recetas prácticas.',
    tipo: 'ARTÍCULO',
    imagen: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=400&h=200&fit=crop',
    categoria: 'Nutrición',
  },
  {
    id: 6,
    titulo: 'Signos de alarma T3',
    descripcion: 'Aprende a identificar señales de alerta durante el tercer trimestre del embarazo.',
    tipo: 'ARTÍCULO',
    imagen: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=400&h=200&fit=crop',
                ...
                <div key={c.id} className={styles.obaCard}>
                  ...
                  <div className={styles.cardBody}>
                    ...
                    <div className={styles.cardActions}>
                      ...
                      <button className={styles.iconBtn} title="Eliminar" onClick={() => eliminar(c.id)}>
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none"
                          stroke="currentColor" strokeWidth="2"
                          strokeLinecap="round" strokeLinejoin="round">
